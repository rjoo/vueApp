<template>
  <div class="date-selection row">
    <div class="small-12 medium-4 columns">
      ...
      <autocomplete
        placeholder="Miami Beach, Manhattan, Las Vegas..."
        :endpoint="locationEndpoint"
        v-on:completed="onLocationEntered"
        ></autocomplete>
    </div>
    ...
    <div class="small-12 medium-6 medium-pull-3 column">
      ...
      <a href="#"
        ...
        v-show="startDate && endDate && location"
    ...
    methods: {
      ...
      onLocationEntered (location) {
        if (location) {
          ...
          this.$dispatch('location-entered', this.location)
        }
      },
      stepCompleted () {
        this.completed = true
      ...
      locationEndpoint: store.getCities
    }
  }
</script>
